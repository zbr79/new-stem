...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvImagePiker.adapter = ImagePickerAdapter(this,chosenImageUris, boardSize)
        rvImagePiker.setHasFixedSize(true)
        rvImagePiker.layoutManager = GridLayoutManager(this, boardSize.getWidth())
    }
