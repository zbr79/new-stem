...
class MemoryBoardAdapter(
    ...
    // How to create 1 view of recycler view
    ...
    // GetItemCount define how many element in recycler vew
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            //If Card is face up, use images
            //Else use background images
            ...
            //If image match, change to gray background
